  ...
  <div class="doc-page">
    ...
    <div class="doc-contact-box">
      ...
      <div class="doc-contact-text">
        ...
        <p>We're happy to clarify anything — no account needed.</p>
        <button class="btn-primary" style="margin-top:10px;width:auto;padding:11px 24px" onclick="openGuestSupport()">💬 Message Support</button>
      </div>
    </div>
  </div>`;
...
export function renderPrivacy() {
  ...
  <div class="doc-page">
    ...
    <div class="doc-section" id="pp-10">
      <div class="doc-section-num">10</div>
      <h2>Contact Us</h2>
      <p>For any privacy-related questions, data requests, or deletion requests — reach out directly. No account needed.</p>
      <ul>
    ...
    <div class="doc-contact-box">
      ...
      <div class="doc-contact-text">
        ...
        <p>We keep your data minimal, secure, and never sell it. Have a question or want your data deleted?</p>
        <button class="btn-primary" style="margin-top:10px;width:auto;padding:11px 24px" onclick="openGuestSupport()">💬 Message Support</button>
      </div>
    </div>
  </div>`;
